...
class LangCallExprImpl(
        last: Lexeme,
        override val referenceExpr: LangReferenceExpr,
        override val arguments: List<LangExpr>
) : LangCallExpr, LangExprImpl(referenceExpr.startOffset, last.endOffset) {
    ...
    private fun makeChildren(): List<AstNode> {
        val nodes = mutableListOf<AstNode>(referenceExpr)
